                        ...
                        <div class="query" style="float:left; overflow:visible;">
                            <div class="queryL queryLH" style="overflow: visible;max-width: 840px;">
                                <p style="width:270px; position:relative;overflow:visible;">
                                    <span><i>*</i>类型名称:</span>
                                    <input type="text" style="width:140px;" value="" name="typeName" id="typeName" class="{required:true,maxlength:32}">
                                </p>
                                <p style="width:270px; position:relative;overflow:visible;">
                                    <span><i>*</i>类型编码:</span>
                                    <input type="text" style="width:140px;" value="" name="typeCode" id="typeCode" class="{required:true,maxlength:32,isEng:true}">
                                </p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="query" style="float:left; overflow:visible;">
                            <div class="queryL queryLH" style="overflow: visible;max-width: 840px;">
                                <p style="width:270px; position:relative;overflow:visible;">
                                    <span><i>*</i>数据名称:</span>
                                    <input type="text" style="width:140px;" value="" name="names" id="name0" class="{required:true,maxlength:32}">
                                </p>
                                <p style="width:270px; position:relative;overflow:visible;">
                                    <span><i>*</i>数据编码:</span>
                                    <input type="text" style="width:140px;" value="" name="codes" id="code0" class="{required:true,maxlength:32,isEng:true}">
                                </p>
