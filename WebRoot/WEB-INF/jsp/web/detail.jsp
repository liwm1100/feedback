...
<section class="container taskDetail">
    ...
    <div class="buttonDiv">
        <input type="button" onclick="window.location.href='/index';" value="返回列表">
        <input type="button" onclick="window.location.href='/toAdd';" value="继续申报">
    </div>
        ...
        <ul>
            ...
            <li>
                ...
                <p>
                    ...
                    <c:if test="${question.state==30}">修复上报</c:if>
